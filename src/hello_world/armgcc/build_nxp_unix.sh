...
# Copy project files
cp $PROJECT_ROOT/src/hello_world/*.c $LF_SOURCE_GEN_DIRECTORY/
cp $PROJECT_ROOT/src/hello_world/*.h $LF_SOURCE_GEN_DIRECTORY/

# Build project
cd $PROJECT_ROOT/src/hello_world/armgcc
